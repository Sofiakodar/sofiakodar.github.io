...
date: 2026-05-24
draft: false
tags: ["ai", "conference", "engineering", "tips"]
cover:
  image: "AIfokus.png"
  alt: "AI fokus 2026"
  relative: true
...
A very interesting and entertaining talk about how to use the right model, open source tools and how to reason about it. I found this very interesting since I have played around with local LLMs lately and want to learn more about it. My MacBook can definitely run many models without problem. 
I got lots of fun ideas from this talk that I would like to experiment with. I did not know that we already can run good models on phones - so that's also something to investigate further. 
